    ...
    <AppBar  sx={{ backgroundColor: 'gray' }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {userToken !== null ? <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            <IconButton
              size="large"
            ...
            >
              ...
              <MenuItem onClick={handleCloseNavMenu}>
                <Button>
                  <Typography textAlign="center"><Link href={'/posts'}>AllPosts</Link></Typography>
                </Button>
              </MenuItem>
            </Menu>
          ...
          {userToken !== null ? <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            <Button
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {userToken !== null ? <MenuItem onClick={handleCloseUserMenu}>
              ...
              {userToken == null ? <Box> <MenuItem onClick={handleCloseUserMenu}>
                <Typography textAlign="center">
                  <Button>
